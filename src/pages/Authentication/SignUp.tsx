...
const SignUp: React.FC = () => {
  ...
  async function handleSubbmit(event: React.FormEvent) {
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubbmit}>
                ...
                <div className="mb-5">
                  ...
                  <button type="submit"
                    className="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90">Create account</button>
