    ...
    const updateUser = async () => {
        try {
            ...
            if (error) {
                ...
                navigate('/signin')
                // Password updated successfully, you might want to redirect or show a success message
            }
        } catch (error) {
...
onClick={updateUser}
                                    ...
                                    className="flex w-full items-center justify-center gap-3.5 rounded-lg border text-primary border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50">Reset Password</button>
